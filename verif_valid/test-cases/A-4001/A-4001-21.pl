...
sub send_DICOM {
 ...
 @image_sets = (
	".4001.21\tNuclear^Med\tA-4001-21\tA-4001-21F",
 );
 ...
 foreach $im(@image_sets) {
  ...
  my $inputFolder = "/opt/test-data/nmi_image_sets";
...
## Main starts here
 ...
 my $y =
 "The prep part of test A-4001-21 is complete.\n" .
