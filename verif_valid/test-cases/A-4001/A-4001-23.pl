...
sub send_DICOM {
 ...
 @image_sets = (
	".4001.23\tKey^Object\tA-4001-23\tA-4001-23F",
 );
 ...
 foreach $im(@image_sets) {
  ...
  my $inputFolder = "/opt/test-data/key_object_selection";
...
## Main starts here
 ...
 my $y =
 "The prep part of test A-4001-23 is complete.\n" .
