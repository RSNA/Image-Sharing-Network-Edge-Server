...
## Main starts here
 ...
 @allFiles = <$targetFolder/A-4001-07-ACC/*>;
 ...
 foreach $f(@allFiles) {
  ...
  die "A-4001-07 fail: at least one file did not pass ($totalPass of $totalFiles did pass)\n" if ($totalPass != $totalFiles);
  die "A-4001-07 fail: test designed for 1 image, not $totalPass\n" if ($totalPass != 1);
  
  print "A-4001-07 pass\n";
