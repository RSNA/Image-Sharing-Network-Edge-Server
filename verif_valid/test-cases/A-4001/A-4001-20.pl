...
sub send_DICOM {
 ...
 @image_sets = (
	".4001.20\tMammo^E\tA-4001-20\tA-4001-20F",
 );
 ...
 foreach $im(@image_sets) {
  ...
  my $inputFolder = "/opt/test-data/mammo_image_sets";
...
## Main starts here
 ...
 my $y =
 "The prep part of test A-4001-20 is complete.\n" .
