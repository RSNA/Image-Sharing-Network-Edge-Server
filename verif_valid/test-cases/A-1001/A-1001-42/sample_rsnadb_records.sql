...
insert into devices
	(ae_title, host, port_number, modified_date) values
	('MOORE-ONE', 'm-one',  104, '2013-03-30 12:00:00-04'),
	('MOORE-TWO', 'm-two', 1112, '2013-04-01 13:00:00-04');
...
insert into jobs
	(job_id, job_set_id, exam_id, report_id, document_id, remaining_retries, modified_date) values
	(1, 1, 1, 1, 'document ID 1', 10, '2013-03-30 16:00:00-04'),
	(2, 2, 2, 2, 'document ID 2',  8, '2013-04-01 16:00:00-04');
