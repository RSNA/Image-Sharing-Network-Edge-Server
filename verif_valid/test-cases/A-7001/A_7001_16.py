...
class A_7001_16():
    def run(self):
        ...
        ## --------------------------------------------------------- ##
        print 'Starting "Reject all" XDS HL7 Receiver'
        ## --------------------------------------------------------- ##
        self.xdsHl7 = HL7ReceiverManager(xdsHl7JarPath, xdsHl7Port, True, True);
        ...
        ## --------------------------------------------------------- ##
        statusCode = baseTest.waitForTransactionStatusCode(jobID, -33, 240);
        ...
        ## --------------------------------------------------------- ##
        if(statusCode != -33):
            return (False, 'Failed Tests: Transaction status code set to: ' +  str(statusCode));
...
if __name__ == "__main__":
    print 'Running A_7001_16 as main()'
    test = A_7001_16();
