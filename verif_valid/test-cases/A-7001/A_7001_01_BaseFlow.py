...
class A_7001_01():
    ...
    def __init__(self, testName, tempDir, dcm4CheDir, mesaDir, mesaToolDir, rsnaDbHost):
        ...
        self.rsnaDbUser = 'edge';
        self.rsnaDbPassword = 'd17bK4#M';
    ...
    def validateRetrievedMetaDataMatch(self, retreivedFilesDirectory, fieldsToValidate):
        print '!!! validateRetrievedMetaDataMatch not implemented !!!'
        return True;
    ...
    def sendDicomFileToPacs(self, aeTitle, host, port, dataDir, customFieldsDictionary):
        ...
        patientID = customFieldsDictionary['PATIENT_ID'];
        accessionNumber = customFieldsDictionary['ACCESSION_NUMBER'];
        dcmManager.sendDicomFiles(dataDir, patientName, patientID, accessionNumber);
    ...
    ## ---------------------------------------------------- ##
    def generateCustomFields(self, studyUID):
        customDemographics = self._generateDemographics();
        customFieldsDictionary = self._loadParameters(customDemographics[0],customDemographics[1],customDemographics[2],customDemographics[3], studyUID);
        return customFieldsDictionary;
            
    def _loadParameters(self, name, patientID, accessionNumber, dateTime, studyUID):
        parameters = {};
        ...
        parameters['STUDY_INSTANCE_UID'] = studyUID;
        
        return parameters;
    
    def _generateDemographics(self):
...
def main():
    # run simple class test
     tester = A_7001_01('tester', '/tmp', '/opt/dcm4che/dcm4che-2.0.25', '/opt/mesa', '/opt/mesa/bin');
     tester.validateKosDcmMatch('/tmp/ACCESSION-20110317105149-broken/retrieved');

    
if __name__ == "__main__":
    print 'Running A_7001_01_BaseFlow as main()'
    main();
