...
# check_environment();
 ...
 image_sharing::construct_hl7_orm_or_oru("$tmpFolderHL7/orm.hl7", "data/ihe_sched.tpl", "data/1002_1.var",  %h);
 image_sharing::construct_hl7_orm_or_oru("$tmpFolderHL7/oru.hl7", "data/ihe_oru.tpl", "data/1002_1.var",  %h);

 image_sharing::xmit_hl7("localhost", 20000, "$tmpFolderHL7/orm.hl7");
 image_sharing::xmit_hl7("localhost", 20000, "$tmpFolderHL7/oru.hl7");
 ...
 my $patIndex =  image_sharing::get_max_pat_id("rsnadb");
